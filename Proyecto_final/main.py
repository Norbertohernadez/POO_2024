...
class App:
    ...
    def main_menu(self):
        ...
        tk.Label(self.root, text="Sistema de Gestión de Empleados", font=("Arial", 30)).pack(pady=40)
    ...
    def iniciar_sesion(self):
        ...
        tk.Label(self.root, text="Iniciar Sesión", font=("Arial", 30)).pack(pady=40)
    ...
    def registrarse(self):
        ...
        tk.Label(self.root, text="Registrarse", font=("Arial", 30)).pack(pady=40)
    ...
    def mostrar_menu_principal(self):
        ...
        tk.Label(self.root, text="Menú Principal", font=("Arial", 30)).pack(pady=40)

        tk.Button(self.root, text="Registrar Reserva", command=self.mostrar_formulario_reserva).pack(pady=20)
        tk.Button(self.root, text="Registrar Cliente", command=self.registrar_cliente).pack(pady=20)
        tk.Button(self.root, text="Registrar Cabaña", command=self.registrar_cabana).pack(pady=20)
        tk.Button(self.root, text="Registrar Actividad", command=self.registrar_actividad).pack(pady=20)
        tk.Button(self.root, text="Cerrar Sesión", command=self.cerrar_sesion).pack(pady=0)
    ...
    def mostrar_formulario_reserva(self):
        ...
        tk.Label(self.root, text="Registrar Reserva", font=("Arial", 30)).pack(pady=40)
    ...
    def registrar_cliente(self):
        ...
        tk.Label(self.root, text="Registrar Cliente", font=("Arial", 30)).pack(pady=40)
        tk.Label(self.root, text="Nombre").pack()
        nombre_entry = tk.Entry(self.root)
        nombre_entry.pack()
        tk.Label(self.root, text="Apellido").pack()
    ...
    def registrar_cabana(self):
        ...
        tk.Label(self.root, text="Registrar Cabaña", font=("Arial", 30)).pack(pady=40)
        tk.Label(self.root, text="Nombre").pack()
        nombre_entry = tk.Entry(self.root)
        nombre_entry.pack()
        ...
        def on_submit():
            ...
            cabana = Cabana.crear(nombre, capacidad, costo)
            if cabana:
    ...
    def registrar_actividad(self):
        ...
        tk.Label(self.root, text="Registrar Actividad", font=("Arial", 30)).pack(pady=40)
